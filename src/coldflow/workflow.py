"""High-level Step 5 cold-flow workflow orchestration."""
...
from src.coldflow.calibration_store import load_calibration_package
from src.coldflow.coldflow_export import write_coldflow_outputs
from src.coldflow.coldflow_types import CalibrationPackage, FeedCalibrationResult, InjectorCalibrationResult, JointCalibrationResult
from src.coldflow.data_ingest import load_coldflow_dataset
from src.coldflow.feed_calibration import calibrate_feed_model
from src.coldflow.hydraulic_predictor import apply_parameter_updates_to_context, build_prediction_context, predict_dataset
...
from src.coldflow.residuals import build_residuals, prediction_rows, residual_rows, residual_statistics
from src.coldflow.surrogate_fluid import surrogate_fluid_warnings
...
def build_calibration_package(
    *,
    ...
    """Build the reusable calibration package exported by the Step 5 workflow."""
...
def _baseline_context(study_config: Mapping[str, Any], coldflow_config: Mapping[str, Any]):
    ...
    uncalibrated_config.setdefault("coldflow", {})["hydraulic_source"] = "nominal_uncalibrated"
...
def run_coldflow_calibration_workflow(
    ...
    """Run Step 5 calibration and export a reusable calibration package."""
